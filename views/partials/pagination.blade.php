@if ($paginator->hasPages())
    {{-- Full link generate --}}
    @php
        $сontroller = new \Seiger\sMailer\Controllers\sMailerController();
        $fullUrl = $сontroller->url . (request()->has('get') ? '&get=' . request()->get : '') . (request()->has('search') ? '&search=' . request()->search : '');
